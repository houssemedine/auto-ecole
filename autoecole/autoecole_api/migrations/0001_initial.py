# Generated by Django 4.2 on 2025-08-18 20:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(choices=[(1, 'Guest'), (2, 'Admin'), (3, 'Owner'), (4, 'Trainer'), (5, 'Student')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='car', to='autoecole_api.car')),
                ...
                ('session_type', models.ForeignKey(default='4', on_delete=django.db.models.deletion.DO_NOTHING, related_name='session_type', to='autoecole_api.sessiontype')),
            ],
            options={
                'ordering': ['day'],
            },
        ...
        migrations.AddField(
            model_name='card',
            name='licence_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='licence_type', to='autoecole_api.licencetype'),
        ),
        migrations.AddField(
            model_name='card',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='school_card', to='autoecole_api.school'),
        ),
        migrations.AddField(
            model_name='card',
            name='status',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, related_name='status', to='autoecole_api.status'),
        ),
        migrations.AddField(
            model_name='card',
            name='student',
        ...
        migrations.AddField(
            model_name='user',
            name='school',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='autoecole_api.school'),
        ),
        migrations.AddField(
            model_name='user',
