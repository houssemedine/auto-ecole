# Generated by Django 4.0.5 on 2024-08-13 21:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fonction', models.PositiveSmallIntegerField(choices=[(1, 'Admin'), (2, 'Owner'), (3, 'Trainer'), (4, 'Student')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('licence_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='licence_type', to='autoecole_api.licencetype')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activities', models.ManyToManyField(blank=True, null=True, to='autoecole_api.activity')),
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='car', to='autoecole_api.car')),
